/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 576e2addbde94a39c6c9314e07854743)
// Runtime types generated with workerd@1.20260815.1 2026-08-19 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	NEXT_PUBLIC_APP_URL: string;
	SEW_LOVELY_CONTENT_FILE: string;
	SEW_LOVELY_CUSTOMERS_FILE: string;
	SEW_LOVELY_ORDERS_FILE: string;
	SEW_LOVELY_ORDER_EMAIL: string;
	CUSTOMER_SESSION_SECRET: string;
	RESEND_API_KEY: string;
	RESEND_FROM_EMAIL: string;
	ORDER_RECEIPT_EMAIL: string;
	NEXT_PUBLIC_SENTRY_STOREFRONT_DSN: string;
	R2_ACCOUNT_ID: string;
	R2_ENDPOINT: string;
	R2_BUCKET: string;
	R2_ACCESS_KEY_ID: string;
	R2_SECRET_ACCESS_KEY: string;
	SENTRY_TEST_MODE: string;
	MOCK_TEST_RECIPIENT: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_APP_URL" | "SEW_LOVELY_CONTENT_FILE" | "SEW_LOVELY_CUSTOMERS_FILE" | "SEW_LOVELY_ORDERS_FILE" | "SEW_LOVELY_ORDER_EMAIL" | "CUSTOMER_SESSION_SECRET" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL" | "ORDER_RECEIPT_EMAIL" | "NEXT_PUBLIC_SENTRY_STOREFRONT_DSN" | "R2_ACCOUNT_ID" | "R2_ENDPOINT" | "R2_BUCKET" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "SENTRY_TEST_MODE" | "MOCK_TEST_RECIPIENT">> {}
}
