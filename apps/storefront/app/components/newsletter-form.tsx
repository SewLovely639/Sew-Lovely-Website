...
export function NewsletterForm() {
  ...
  async function subscribe(formData: FormData) {
    ...
    const result = await response.json().catch(() => null) as { message?: string } | null; setMessage(response.ok ? "Thank you — you’re on the list." : result?.message ?? "Please try again.");
  }
