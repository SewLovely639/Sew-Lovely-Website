...
## Local storefront review

The homepage at `http://localhost:3000/` rendered with the supplied Sew Lovely logo in the navigation, branded circular hero controls, the requested Permanent Marker typography, distinct Gift Box mood icons, and no Scan & Connect section. The newsletter field displays one visible email prompt after the screen-reader-only utility was added.
